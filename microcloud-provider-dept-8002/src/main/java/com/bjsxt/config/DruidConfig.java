...
/**
 * Druid访问url：http://localhost:8001/druid/index.html
 */
@Configuration
public class DruidConfig {
    ...
    public ServletRegistrationBean druidServlet() { // 主要实现WEB监控的配置处理
        ...
        servletRegistrationBean.addInitParameter("allow", "127.0.0.1,192.168.209.1"); // 白名单
        servletRegistrationBean.addInitParameter("deny", "192.168.209.200"); // 黑名单
